...
import com.google.mlkit.vision.demo.CustomRectangleWithRoundedCornersCutoutView;
...
public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
  ...
  private float scanAreaBottom;
  private float scanAreaRight;

  private CustomRectangleWithRoundedCornersCutoutView rectOverly;
  ...
  public BarcodeScannerProcessor(Context context, @Nullable ZoomCallback zoomCallback, CustomRectangleWithRoundedCornersCutoutView rectOverly) {
  this(context, zoomCallback);
  this.rectOverly = rectOverly;
  scanAreaTop = rectOverly.getYAxisTopEdge();
  scanAreaBottom = rectOverly.getYAxisBottomEdge();
  scanAreaLeft = rectOverly.getXAxisLeftEdge();
  scanAreaRight = rectOverly.getXAxisRightEdge();
  }
  ...
  private boolean withinScanArea(float top, float left, float bottom, float right) {
    return top > rectOverly.getYAxisTopEdge() &&
           left > rectOverly.getXAxisLeftEdge() &&
           bottom < rectOverly.getYAxisBottomEdge() &&
           right < rectOverly.getXAxisRightEdge();
}
  ...
  protected void onSuccess(
      @NonNull List<Barcode> barcodes, @NonNull GraphicOverlay graphicOverlay) {
        ...
        if (rectOverly != null) {
          Log.v(MANUAL_TESTING_LOG, "No barcode has been detected" + rectOverly.getXAxisLeftEdge() + "R" + rectOverly.getXAxisRightEdge());
        }
